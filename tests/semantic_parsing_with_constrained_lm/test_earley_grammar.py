...
from semantic_parsing_with_constrained_lm.earley.grammar import LinearDottedRule, Nonterm
from semantic_parsing_with_constrained_lm.scfg.earley_grammar import EarleyCFGrammar
...
def test_grammar_1():
    ...
    assert utt_grammar.expansions == {
        Nonterm("start"): {
            LinearDottedRule.from_rule(Nonterm("start"), ("abc",)),
            LinearDottedRule.from_rule(Nonterm("start"), ("a", Nonterm("b"))),
        },
        Nonterm("b"): {LinearDottedRule.from_rule(Nonterm("b"), ("bd",))},
    }
...
def test_grammar_2():
    ...
    assert utt_grammar.expansions == {
        Nonterm("start"): {
            LinearDottedRule.from_rule(Nonterm("start"), (Nonterm("quoted"),)),
        },
        Nonterm("quoted"): {
        ...
        Nonterm("nonquotestar"): {
            ...
            LinearDottedRule.from_rule(Nonterm("nonquotestar"), ()),
        },
    }
