...
#SBATCH -o /brtx/601-nvme1/estengel/calflow_calibration/benchclamp/logs/dev_eval_t5.out 
#SBATCH -p brtx6
#SBATCH --gpus=4
...
python -m semantic_parsing_with_constrained_lm.run_exp \
    --config-name semantic_parsing_with_constrained_lm.configs.benchclamp_config \
    --exp-name-pattern 't5-large-lm-adapt_calflow_last_user_all_0.0001_10000_dev_eval_unconstrained-beam_bs_5'
